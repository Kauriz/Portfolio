...
export function SalleProfil() {
    return (
        <group>
            ...
            <ImagePlane path={"/textures/mountain.png"} position={[28.3,2.3,-28.64]} scale={[1,1,1]} rotation={[-Math.PI/11,-Math.PI/4.3,-Math.PI/15]} />
            <ImagePlane path={"/textures/hoodie.png"} position={[25.03,3.5,-29.96]} scale={[0.6,0.6,0.6]} rotation={[0,0,0]} />
            <ImagePlane path={"/textures/chess.png"} position={[22.03,2,-29.96]} scale={[0.6,0.6,0.6]} rotation={[0,0,0]} />
            <ImagePlane path={"/textures/music.png"} position={[24,2,-20.04]} scale={[0.65,0.5,0.5]} rotation={[0,Math.PI,0]} />
        </group>
    )
}