...
useGLTF.preload(BASE + 'models/pillar.glb')
...
export function SalleProjet({ onNear, onLeave, playerPositionRef }) {
    ...
    return (
        <group>
            ...
            <ImagePlane path={BASE + "textures/contactSign.png"} position={[-12,2.5,-18.01]} scale={[1,1,1]} rotation={[0,-Math.PI,0]} /> 
            <ImagePlane path={BASE + "textures/experienceSign.png"} position={[-1.99,2.5,-37]} scale={[1,1,1]} rotation={[0,Math.PI/2,0]} /> 
            <ImagePlane path={BASE + "textures/projetSign.png"} position={[-1.99,2.5,-13.5]} scale={[1,1,1]} rotation={[0,Math.PI/2,0]} /> 
        </group>
    )
}